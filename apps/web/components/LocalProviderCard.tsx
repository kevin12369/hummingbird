...
const KEYS = {
  provider: 'hummingbird:local:provider',
  baseUrl: 'hummingbird:local:baseUrl',
  model: 'hummingbird:local:model',
  apiKey: 'hummingbird:local:apiKey',
  timeoutMs: 'hummingbird:local:timeoutMs',
} as const;
